import{P as h}from"./PureTaskList-574a0fc3.js";import{Default as s}from"./Task.stories-8afad5a9.js";import"./Task-cd6abe3c.js";import"./vue.esm-bundler-d4da4ca6.js";import"./v4-4a60fe23.js";const L={component:h,title:"PureTaskList",tags:["autodocs"],decorators:[()=>({template:'<div style="margin: 1em;"><story/></div>'})],argTypes:{onPinTask:{},onArchiveTask:{}}},a={args:{tasks:[{...s.args.task,id:"1",title:"Task 1"},{...s.args.task,id:"2",title:"Task 2"},{...s.args.task,id:"3",title:"Task 3"},{...s.args.task,id:"4",title:"Task 4"},{...s.args.task,id:"5",title:"Task 5"},{...s.args.task,id:"6",title:"Task 6"}]}},e={args:{tasks:[...a.args.tasks.slice(0,5),{id:"6",title:"Task 6 (pinned)",state:"TASK_PINNED"}]}},t={args:{tasks:[],loading:!0}},r={args:{...t.args,loading:!1}};var n,i,o;a.parameters={...a.parameters,docs:{...(n=a.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
